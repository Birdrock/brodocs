  ...
  template:
    ...
    spec:
      ...
      - name: pi
        ...
        command: ["perl",  "-Mbignum=bpi", "-wle", "print bpi(2000)"]
      restartPolicy: Never
' http://127.0.0.1:8001/apis/extensions/v1beta1/namespaces/default/jobs
...
' http://127.0.0.1:8001/apis/extensions/v1beta1/namespaces/default/jobs/example-job
...
$ kubectl proxy
$ curl -X GET http://127.0.0.1:8001/apis/extensions/v1beta1/namespaces/default/jobs/example-job
...
$ kubectl proxy
$ curl -X GET 'http://127.0.0.1:8001/apis/extensions/v1beta1/namespaces/default/jobs'
...
Code         | Description
------------ | -----------
200 <br /> [JobList](#joblist-v1beta1) | OK
...
$ kubectl proxy
$ curl -X GET 'http://127.0.0.1:8001/apis/extensions/v1beta1/watch/namespaces/default/jobs/example-job'
